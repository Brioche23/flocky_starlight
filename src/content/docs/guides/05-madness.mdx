...
<Vimeo vimeoId="895001344" controls="false">
  _Fig 5.1 – Demo Madness Behind the Scenes_
</Vimeo>

## The Stand

![Madness Stand](../../../assets/img/04_madness/01.png)
_Fig 5.2 – Madness Stand_

<Tabs>
  <TabItem label="01 - Intro">
    ![Introducing our Project to Davide Lovino, from RunChallenge](../../../assets/img/04_madness/02.jpg)
    _Fig 5.3 – Introducing our Project to Davide Lovino, from RunChallenge_
...
We also had a Branding Poster, showcasing the core value of our solution: the RunChallenge runners happily jogging connected by the Flocky system.
  ...
  <TabItem label="03 - Demo">
    ...
    _Fig 5.6 – Staff member helps wearing the Flocky Prototype_
...
_Fig 5.12 – The whole Flocky team at the Madness_
